...
func deepEqualsOnDemandResources(_ lhs: Any?, _ rhs: Any?) -> Bool {
  ...
  case let (cleanLhsArray, cleanRhsArray) as ([Any?], [Any?]):
    ...
    for (index, element) in cleanLhsArray.enumerated() {
      if !deepEqualsOnDemandResources(element, cleanRhsArray[index]) {
        return false
      }
    }
    return true
  ...
  case let (cleanLhsDictionary, cleanRhsDictionary) as ([AnyHashable: Any?], [AnyHashable: Any?]):
    ...
    for (key, cleanLhsValue) in cleanLhsDictionary {
      ...
      if !deepEqualsOnDemandResources(cleanLhsValue, cleanRhsDictionary[key]!) {
        return false
      }
    }
    return true
...
func deepHashOnDemandResources(value: Any?, hasher: inout Hasher) {
  if let valueList = value as? [AnyHashable] {
     for item in valueList { deepHashOnDemandResources(value: item, hasher: &hasher) }
     return
  }
  ...
  if let valueDict = value as? [AnyHashable: AnyHashable] {
    for key in valueDict.keys { 
      hasher.combine(key)
      deepHashOnDemandResources(value: valueDict[key]!, hasher: &hasher)
    }
    return
  }
...
struct IOSOnDemandResourcesPigeon: Hashable {
  ...
  static func == (lhs: IOSOnDemandResourcesPigeon, rhs: IOSOnDemandResourcesPigeon) -> Bool {
    return deepEqualsOnDemandResources(lhs.toList(), rhs.toList())  }
  func hash(into hasher: inout Hasher) {
    deepHashOnDemandResources(value: toList(), hasher: &hasher)
  }
}
...
///
/// Generated class from Pigeon that represents data sent in messages.
struct IOSOnDemandResourcePigeon: Hashable {
  var tag: String
  ...
  static func == (lhs: IOSOnDemandResourcePigeon, rhs: IOSOnDemandResourcePigeon) -> Bool {
    return deepEqualsOnDemandResources(lhs.toList(), rhs.toList())  }
  func hash(into hasher: inout Hasher) {
    deepHashOnDemandResources(value: toList(), hasher: &hasher)
  }
...
///
/// Generated class from Pigeon that represents data sent in messages.
struct IOSNSErrorPigeon: Hashable {
  var code: Int64
  var domain: String
  var localizedDescription: String
  ...
  static func == (lhs: IOSNSErrorPigeon, rhs: IOSNSErrorPigeon) -> Bool {
    return deepEqualsOnDemandResources(lhs.toList(), rhs.toList())  }
  func hash(into hasher: inout Hasher) {
    deepHashOnDemandResources(value: toList(), hasher: &hasher)
  }
...
///
/// Generated class from Pigeon that represents data sent in messages.
struct IOSProgressPigeon: Hashable {
  ...
  static func == (lhs: IOSProgressPigeon, rhs: IOSProgressPigeon) -> Bool {
    return deepEqualsOnDemandResources(lhs.toList(), rhs.toList())  }
  func hash(into hasher: inout Hasher) {
    deepHashOnDemandResources(value: toList(), hasher: &hasher)
  }
