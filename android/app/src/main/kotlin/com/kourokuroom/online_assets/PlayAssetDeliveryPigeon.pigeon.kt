...
private open class PlayAssetDeliveryPigeonPigeonCodec : StandardMessageCodec() {
...
val PlayAssetDeliveryPigeonPigeonMethodCodec = StandardMethodCodec(PlayAssetDeliveryPigeonPigeonCodec());



private class PlayAssetDeliveryPigeonPigeonStreamHandler<T>(
    val wrapper: PlayAssetDeliveryPigeonPigeonEventChannelWrapper<T>
...
interface PlayAssetDeliveryPigeonPigeonEventChannelWrapper<T> {
...
abstract class StreamAssetPackStateStreamHandler : PlayAssetDeliveryPigeonPigeonEventChannelWrapper<AndroidAssetPackStatePigeon> {
  companion object {
    fun register(messenger: BinaryMessenger, streamHandler: StreamAssetPackStateStreamHandler, instanceName: String = "") {
      ...
      val internalStreamHandler = PlayAssetDeliveryPigeonPigeonStreamHandler<AndroidAssetPackStatePigeon>(streamHandler)
      EventChannel(messenger, channelName, PlayAssetDeliveryPigeonPigeonMethodCodec).setStreamHandler(internalStreamHandler)
    }
  }
}
...
interface PlayAssetDeliveryHostApiMethods {
  ...
  companion object {
    ...
    val codec: MessageCodec<Any?> by lazy {
      PlayAssetDeliveryPigeonPigeonCodec()
    }
